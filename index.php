            ...
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="login.php">Login</a>
			        ...
			        <li class="nav-item">
                <a class="nav-link active" href="https://drive.google.com/file/d/1ZFBgQb-frWezzyGXHVhXv6dsgpAxI7ya/view?usp=sharing" style="background-color: #cd5c5c; padding: 5px 10px;">Download APK!</a>
              </li>
            </ul>
        ...
        $Satuan = $tampil['Satuan'];
          ...
          ?>
            ...
            Swal.fire({
              icon: 'error',
              title: 'Oops...',
              text: 'Barang yang anda cari tidak ada!',
            })
            </script>
            <?php
          }
