...
if ($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    $insertDetailTrx = "INSERT INTO detail_transaksi (idTransaksi, kdBarang, idPembeli, Jumlah, sub_total, idkeranjang) VALUES ('$idTransaksi', '$kdBarang', '$idPembeli', '$Jumlah', '$sub_total', '$idkeranjang')";
