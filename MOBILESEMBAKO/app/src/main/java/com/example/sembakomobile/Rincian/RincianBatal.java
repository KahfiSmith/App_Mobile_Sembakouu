...
public class RincianBatal extends AppCompatActivity {
    private RecyclerView.Adapter rincian;
    List<DataKeranjang> listDataKeranjangSengDipilihUser;
    private List<DataDetailTransaksi> dibatalkan = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rincian_batal);
        ...
        nama.setText(SaveAccount.readDataPembeli(RincianBatal.this).getNamaPembeli());

        alamat = findViewById(R.id.text_alamat);
        alamat.setText(SaveAccount.readDataPembeli(RincianBatal.this).getAlamat());

    }
    public void retrieveData() {
        rincian = new AdapterCheckout(RincianBatal.this, listDataKeranjangSengDipilihUser);
